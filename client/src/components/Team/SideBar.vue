<template>
    <div class="w-full lg:w-1/3 bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-2xl p-6 transform transition-all duration-300 hover:scale-[1.02]">
      <!-- Team Stats Section -->
      <div class="mb-8">
      ...
      <div class="mb-8">
        ...
        <div class="space-y-2">
          <div 
            v-for="(fixture, index) in upcomingFixtures.slice(0, 3)" 
            :key="index" 
            class="bg-green-50 rounded-lg p-3 flex justify-between items-center hover:bg-green-100 transition-colors"
          >
            <span class="text-gray-700">{{ fixture.match }}</span>
            <span class="text-gray-500">{{ fixture.date }}</span>
          </div>
      ...
      <div>
        ...
        <div class="space-y-2">
          <div 
            v-for="(performer, index) in topPerformers.slice(0, 3)" 
            :key="index" 
