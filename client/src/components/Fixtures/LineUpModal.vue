    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
      ...
      <div class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <!-- Home Team Lineup -->
          <div v-for="lineup in fixture.lineups" :key="lineup.id"
            ...
            <div class="mb-6">
              ...
              <div class="space-y-2">
                <div v-for="(player, index) in lineup.starters" :key="player.id"
                  ...
                  <div class="flex items-center space-x-3 min-w-0 flex-1">
                    <div
                      class="flex items-center justify-center w-6 h-6 bg-gray-100 rounded text-xs font-medium text-gray-600">
                      {{ index + 1 }}
                    </div>
                  ...
                  <div class="text-xs font-medium px-2 py-1 rounded-full" :class="getPositionColor(player.position)">
                    {{ player.position }}
                  </div>
                </div>
              </div>
            ...
            <div v-if="lineup.bench.length > 0">
              ...
              <div class="space-y-2">
                <div v-for="(player, index) in lineup.bench" :key="player.id"
                  class="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg hover:shadow-sm transition-all duration-200">
                  <div class="flex items-center space-x-3 min-w-0 flex-1">
                    <div
                      class="flex items-center justify-center w-6 h-6 bg-gray-100 rounded text-xs font-medium text-gray-600">
        ...
        <div v-if="fixture.lineups.length === 1"
        ...
        <!-- No Lineups State -->
        <div v-if="fixture.lineups.length === 0"
