<template>
  <div class="bg-gradient-to-br from-gray-50 to-blue-50 p-4 sm:p-6 md:p-8 rounded-2xl mx-2 sm:mx-4 shadow-lg mb-3">
    ...
    <div class="mx-auto">
      <!-- 3-column grid: left 2 columns, right 1 column -->
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">

        <!-- ================= LEFT PANEL (GAMEWEEK DETAILS) ================= -->
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-gray-300 text-xs sm:text-sm mt-1">
                    Top performers from GW{{ gameweekStatus.gameweek.number }}
                  </p>
                </div>
              </div>
            </div>
