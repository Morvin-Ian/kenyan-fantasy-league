<template>
    <div class="bg-gradient-to-br from-gray-50 to-blue-50 p-8 rounded-2xl shadow-lg">
        ...
        <!-- Matches Container -->
        <div ref="scrollContainer" class="flex gap-6 overflow-x-auto pb-6 hide-scrollbar">
            <div v-for="(game, index) in games" :key="game.id" :style="{ animationDelay: `${index * 100}ms` }"
