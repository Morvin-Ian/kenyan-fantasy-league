          ...
          >
            <div class="aspect-video bg-gray-200 ">
              ...
              <div class="absolute inset-0 flex items-center justify-center relative">
                <iframe width="853" height="480" src="https://www.youtube.com/embed/_q1KiLWGY_o" title="The Money Test You Need To Take." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
              </div>
            </div>
            ...
            <div class="p-4">
              <div class="flex items-center justify-between mb-2">
                ...
                <span
                  class="px-2 py-1 bg-gray-100 rounded-full text-xs font-medium text-gray-600"
                >
                  {{ goal.matchType }}
                </span>
              </div>
