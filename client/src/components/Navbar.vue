<template>
    <div>
        ...
        <nav
            class="md:hidden fixed bottom-0 p-4 left-0 right-0 bg-white border-t border-gray-200 mx-2 mb-1 rounded-t-3xl"
        >
            <div class="grid grid-cols-5 h-16">
                <a
                    ...
                    :class="[item.current ? 'text-red-600' : 'text-gray-600']"
                >
