<template>
  <div>
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 bg-gray-100 border-t rounded-full border-gray-200 mx-4 mb-4">
      <div class="grid grid-cols-4 h-16">
        <a v-for="item in mobileNavItems" :key="item.name" 
          :href="item.href"
...
const mobileNavItems = ref([
  { name: 'Leagues', href: '#', icon: "fa-solid fa-trophy", current: true },
  { name: 'Teams', href: '#', icon: "fa-solid fa-users", current: false },
  { name: 'Fixtures', href: '#', icon: "fa-solid fa-calendar", current: false },
