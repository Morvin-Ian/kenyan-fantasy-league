  ...
  <div class="p-2 sm:p-4">
    <div class="max-w-7xl mx-auto space-y-4 sm:space-y-8">
      ...
      <div class="text-center bg-white/80 backdrop-blur-sm p-4 sm:p-8 rounded-xl">
        <h1 class="text-lg sm:text-xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-600 to-gray-700 mb-2 sm:mb-4">
          Leagues & Cups
        </h1>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
          ...
          <div class="space-y-3 sm:space-y-4">
            <div class="bg-blue-50/50 p-3 sm:p-4 rounded-lg">
              ...
              <div class="flex flex-col xs:flex-row space-y-2 xs:space-y-0 xs:space-x-2 sm:space-x-4">
                <button class="bg-blue-500 text-white px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm rounded-lg hover:bg-blue-600 transition w-full xs:w-auto">
                  Create League
                </button>
                <button class="border border-green-500 text-green-600 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm rounded-lg hover:bg-green-50 transition w-full xs:w-auto">
                  Join League
                </button>
              </div>
            </div>
        ...
        <!-- Global Leagues -->
        <div class="bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-xl sm:rounded-2xl p-4 sm:p-6 sm:col-span-2 lg:col-span-1">
            ...
            <table class="w-full text-left text-xs sm:text-sm">
              ...
              <tbody>
                <tr v-for="league in globalLeagues" :key="league.name" class="border-b">
                  ...
                  <td class="p-2 sm:p-4">
                    <button class="bg-blue-500 text-white px-2 py-1 sm:px-4 sm:py-2 text-xs sm:text-sm rounded-lg hover:bg-blue-600 transition">
                      View
                    </button>
                  </td>
                </tr>
