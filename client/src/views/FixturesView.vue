    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="bg-white rounded-xl shadow-xl overflow-hidden mb-6">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
          ...
          <div class="flex space-x-1">
            <span v-for="week in 5" :key="week" :class="[
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-3 bg-white rounded-xl shadow-lg overflow-hidden mb-6">
          ...
          <div class="p-4">
            <div
              class="bg-gradient-to-r from-red-50 to-white p-4 rounded-lg shadow-md mb-4 border border-red-100 transform hover:scale-[1.01] transition-all">
              <div class="flex flex-col sm:flex-row items-center justify-between">
                <div class="flex items-center space-x-4 mb-4 sm:mb-0">
                  <div class="flex flex-col items-center">
                    <div
                      class="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center overflow-hidden border-2 border-blue-200">
          ...
          <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
            ...
            <div class="p-6">
              <div v-for="(dayFixtures, date) in groupedFixtures" :key="date" class="mb-8">
                ...
                <div class="space-y-4">
                  <div v-for="fixture in dayFixtures" :key="fixture.id"
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between">
                      <div class="flex items-center justify-between w-full sm:w-auto sm:space-x-8">
                        <div class="flex flex-col items-center">
                          <div
                            class="w-14 h-14 bg-gray-100 rounded-full flex items-center justify-center overflow-hidden border border-gray-200 mb-2">
                      ...
                      <div class="mt-4 sm:mt-0">
                        <button
                          class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition flex items-center">
        ...
        <div class="md:col-span-1">
          <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
            ...
            <div class="p-4">
              <div class="space-y-4">
                <div v-for="result in completedFixtures" :key="result.id"
                  ...
                  <div class="flex flex-col items-center">
                    ...
                    <div class="grid grid-cols-3 items-center w-full mb-3">
                      <div class="flex flex-col items-center justify-center">
                        <div
                          class="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mb-1 border border-gray-200">
                      ...
                      <div class="flex items-center justify-center">
                        <div class="bg-gray-200 px-4 py-2 rounded text-center">
                          <div class="text-2xl font-bold text-gray-800">{{ result.homeScore }} - {{ result.awayScore }}
                          </div>
                    ...
                    <button
                      class="w-full bg-gray-700 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-800 transition mt-2 flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path fill-rule="evenodd"
          ...
          <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-4">
              <div class="space-y-4">
                <div
                  class="bg-gray-50 p-4 rounded-lg border border-gray-100 hover:border-indigo-200 transition transform hover:scale-[1.01]">
                  ...
                  <p class="text-sm text-gray-600 mb-2">The striker is expected to miss the next three matches due to an
                    ankle injury sustained during training.</p>
                ...
                <div
                  ...
                  <p class="text-sm text-gray-600 mb-2">Reports suggest United are preparing a bid for the 19-year-old
                    sensation in the upcoming transfer window.</p>
