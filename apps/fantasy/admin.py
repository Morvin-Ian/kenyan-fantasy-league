...
class FantasyPlayerInline(admin.TabularInline):
    model = FantasyPlayer
    extra = 0
    fields = ('player', 'is_starter', 'is_captain', 'is_vice_captain', 'purchase_price', 'current_value')
...
class PlayerPerformanceInline(admin.TabularInline):
    ...
    extra = 0
    fields = ('minutes_played', 'goals_scored', 'assists', 'clean_sheets', 'yellow_cards', 'red_cards')
